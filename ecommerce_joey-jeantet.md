...
> Un clone permet de copier une repo git avec la remote, un fork permet de copier un repo git et de modifier la remote pour la sienne.
...
> src/js/script.js, la commande est git status
